...
echo "======================================"
echo "Testing API..."
curl -s http://20.195.127.226:8080/health > /dev/null && echo "✅ API is healthy" || echo "❌ API failed"

echo "Testing Frontend..."
curl -s http://20.195.127.226:3000 > /dev/null && echo "✅ Frontend is healthy" || echo "❌ Frontend failed"

echo "Testing RAG Service..."
curl -s http://20.195.127.226:8001/health > /dev/null && echo "✅ RAG is healthy" || echo "❌ RAG failed"
...
echo "  Frontend: http://20.195.127.226:3000"
echo "  API:      http://20.195.127.226:8080"
echo "  RAG:      http://20.195.127.226:8001"
echo ""
